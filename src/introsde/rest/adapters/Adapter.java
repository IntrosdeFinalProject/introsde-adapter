...
public class Adapter {
    ...
    public Response getPicture() throws ClientProtocolException, IOException {
        String[] tags = {"fitmotivation", "nordicwalking" , "nordicwalkingwa" , "fitnessquotes_"};
        int randomNum = 0 + (int)(Math.random()*(tags.length-1));

        final String ACCESS_TOKEN = "1982641223.1677ed0.e7bbb48634704f9db306da491c8697e4";
        String ENDPOINT = "https://api.instagram.com/v1/tags/"+tags[randomNum]+"/media/recent?random=true&access_token="+ACCESS_TOKEN;

        //String ENDPOINT = "https://api.instagram.com/v1/tags/WYMTM/media/recent?random=true&access_token=1982641223.1677ed0.e7bbb48634704f9db306da491c8697e4";
